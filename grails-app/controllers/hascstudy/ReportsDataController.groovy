package hascstudy
import restServices.ReportsDataService
import org.springframework.dao.DataIntegrityViolationException
import grails.converters.*
import hascstudy.DashboardReport
import tutorapp.*
import tutorapp.ReportValues
import groovyx.net.http.*

class ReportsDataController {
	...
	def jsonList() {
		//def clientRequest = http.request.getHeader("accept")
		  //def serverResponse = http.request.format
		  //def requestMethod = http.request.method
