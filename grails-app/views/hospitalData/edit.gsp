...
<html>
	...
	<body>
		<a href="#edit-hospitalData" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-hospitalData" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${hospitalDataInstance?.version}" />
				<fieldset class="form">
