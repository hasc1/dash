	...
	<body>
		...
		<div id="show-hospital" class="content scaffold-show" role="main">
			...
			<ol class="property-list hospital">
				...
				<g:if test="${hospitalInstance?.hospitalName}">
				<li class="fieldcontain">
					<span id="hospitalName-label" class="property-label"><g:message code="hospital.hospitalName.label" default="Hospital Name" /></span>
					
						<span class="property-value" aria-labelledby="hospitalName-label"><g:fieldValue bean="${hospitalInstance}" field="hospitalName"/></span>
